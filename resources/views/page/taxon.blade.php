    ...
    <div class="container" style="padding: 1%">
        ...
        <div class="row" id="tree">
            <div class="col-12" style="color:whitesmoke">
                ...
                <a style="color: antiquewhite" href="/taxon/{{ $t->taxonID }}">{{ $t->eol && !empty($t->eol->jp) ?
                    $t->eol->jp : $t->canonicalName }}</a>
                >
                @endforeach
            </div>
        </div>
            ...
            <div class="col-6" style="overflow-x: hidden">
                <table class="table" style="color: antiquewhite">
                    ...
                    <tr>
                        <td>
                            @if ($taxon->iucn2)
                                <span class="{{ $taxon->iucn2->category }}">{{ $taxon->iucn2->category }}</span>
                                {{ $taxon->iucn2->population_trend }}
                            @endif
                        </td>
                    <tr>
