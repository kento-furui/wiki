...
<div class="row">
    <div class="col-6" id="table" style="overflow: hidden">
        <table class="table" style="color: antiquewhite;">
            ...
            <tr>
                <th>Parent</th>
                <td>
                    <a class="btn btn-primary" href="/page/{{ $taxon->parentNameUsageID }}">{{ $taxon->parentNameUsageID
                        }}</a>
                </td>
            </tr>
            <tr>
    ...
    <div class="col-6" id="image">
        @if ($taxon->image)
        <a href="{{ $taxon->image->eolMediaURL }}" data-lightbox="image" data-title="{{ $taxon->image->title }}">
